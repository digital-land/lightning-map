...
var/merged.geojson: var/cache/england.geojson var/snapshot.geojson bin/merge.py
	python3 bin/merge.py var/cache/england.geojson var/snapshot.geojson > $@
...
var/cache/england.geojson:	var/cache/border.geojson bin/filter.py
	python3 bin/filter.py "^E" var/cache/border.geojson > $@
